...
public class FragmentProfilePost extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState)
    {
        ...
        final LinearLayoutManager LinearLayoutManagerPost = new LinearLayoutManager(context);
        ...
        RecyclerViewPost.addOnScrollListener(new RecyclerView.OnScrollListener()
        {
            ...
            {
                if (!LoadingBottom && (LinearLayoutManagerPost.findLastVisibleItemPosition() + 5) > LinearLayoutManagerPost.getItemCount())
                {
                    LoadingBottom = true;
                    PostList.add(null);
    ...
    {
        super.onPause();
        AndroidNetworking.cancel("FragmentProfilePost");
    }
