...
public class CircularProgressView extends View
{
    ...
    private void initAttributes(AttributeSet attrs, int defStyle)
    {
        ...
        currentProgress = a.getFloat(R.styleable.CircularProgressView_cpv_progress, 0);
        ...
        autostartAnimation = a.getBoolean(R.styleable.CircularProgressView_cpv_animAutostart, false);
    ...
    private interface CircularProgressViewListener
    {
    ...
    private class CircularProgressViewAdapter implements CircularProgressViewListener
    {
