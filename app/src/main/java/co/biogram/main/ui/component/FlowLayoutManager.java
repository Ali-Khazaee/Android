...
public class FlowLayoutManager extends RecyclerView.LayoutManager
{
    ...
    FlowLayoutHelper flowLayoutHelper;
    FlowLayoutHelper newFlowLayoutHelper;
    ...
    {
        flowLayoutHelper = new FlowLayoutHelper();
        newFlowLayoutHelper = FlowLayoutHelper.clone(flowLayoutHelper);
    }
    ...
    private void onPreLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state)
    {
        ...
        Point point = layoutHelper.layoutStartPoint(LayoutContext.fromLayoutOptions(flowLayoutHelper));
        ...
        LayoutContext beforeContext = LayoutContext.fromLayoutOptions(flowLayoutHelper);
        ...
        afterContext.layoutOptions.itemsPerLine = newFlowLayoutHelper.itemsPerLine;
        ...
        flowLayoutHelper = FlowLayoutHelper.clone(newFlowLayoutHelper);
    }
    ...
    private void onRealLayoutChildren(RecyclerView.Recycler recycler)
    {
        ...
        boolean newLine;
        Rect rect = new Rect();
        LayoutContext layoutContext = LayoutContext.fromLayoutOptions(flowLayoutHelper);
    ...
    {
        this.flowLayoutHelper = FlowLayoutHelper.clone(newFlowLayoutHelper);
        if (cacheHelper != null)
        {
            cacheHelper.clear();
        }
        cacheHelper = new CacheHelper(flowLayoutHelper.itemsPerLine, layoutHelper.visibleAreaWidth());
    ...
    private void addNewLineAtTop(RecyclerView.Recycler recycler)
    {
        ...
        y = bottom - height;
        firstItem = true;
        layoutContext = LayoutContext.fromLayoutOptions(flowLayoutHelper);
    ...
    private boolean lineVisible(int index)
    {
        ...
        View maxHeightItem = getChildAt(maxHeightItemIndex);
        return Rect.intersects(new Rect(leftVisibleEdge(), topVisibleEdge(), rightVisibleEdge(), bottomVisibleEdge()), new Rect(leftVisibleEdge(), getDecoratedTop(maxHeightItem), rightVisibleEdge(), getDecoratedBottom(maxHeightItem)));
    }
    ...
    {
        newFlowLayoutHelper.alignment = alignment;
        return this;
    }
    ...
    public FlowLayoutManager singleItemPerLine()
    {
        ...
        {
            flowLayoutHelper.itemsPerLine = 1;
        }
        else
        {
            newFlowLayoutHelper.itemsPerLine = 1;
        }
        if (cacheHelper != null)
        {
            cacheHelper.clear();
    ...
    public FlowLayoutManager maxItemsPerLine(int itemsPerLine)
    {
        if (layoutHelper == null)
        {
            flowLayoutHelper.itemsPerLine = itemsPerLine;
        }
        else
        {
            newFlowLayoutHelper.itemsPerLine = itemsPerLine;
        }
        if (cacheHelper != null)
        {
            cacheHelper.clear();
    ...
    public FlowLayoutManager removeItemPerLineLimit()
    {
        if (layoutHelper == null)
        {
            flowLayoutHelper.itemsPerLine = FlowLayoutHelper.ITEM_PER_LINE_NO_LIMIT;
        }
        else
        {
            newFlowLayoutHelper.itemsPerLine = FlowLayoutHelper.ITEM_PER_LINE_NO_LIMIT;
        }
        if (cacheHelper != null)
        {
            cacheHelper.clear();
        ...
        if (layoutHelper != null)
        {
            cacheHelper = new CacheHelper(FlowLayoutHelper.ITEM_PER_LINE_NO_LIMIT, layoutHelper.visibleAreaWidth());
        }
        return this;
    }
    ...
    {
        return calcChildLayoutRect(child, x, y, lineHeight, LayoutContext.fromLayoutOptions(flowLayoutHelper), rect);
    }
    ...
    {
        return startNewline(rect, LayoutContext.fromLayoutOptions(flowLayoutHelper));
    ...
    {
        return advanceInSameLine(x, rect, LayoutContext.fromLayoutOptions(flowLayoutHelper));
    }
    ...
    {
        return layoutHelper.layoutStartPoint(LayoutContext.fromLayoutOptions(flowLayoutHelper));
    }

    private boolean isStartOfLine(int index)
    {
        return isStartOfLine(index, LayoutContext.fromLayoutOptions(flowLayoutHelper));
    }
    ...
    {
        return isEndOfLine(index, LayoutContext.fromLayoutOptions(flowLayoutHelper));
    }
