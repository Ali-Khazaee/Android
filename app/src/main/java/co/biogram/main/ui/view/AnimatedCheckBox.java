...
public class AnimatedCheckBox extends View implements Checkable
{
    ...
    private void init(AttributeSet attrs)
    {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_stroke_width, Misc.ToPX(getContext(), 0));
        ta.recycle();
    ...
    {
        int defSize = Misc.ToPX(getContext(), DEF_DRAW_SIZE);
