    ...
    public void OnCreate() {
        ...
        view.findViewById(R.id.ImageButtonCreate).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    signupObject.put("Name", EditTextName.getText().toString());
                        ...
                        try {
                            ...
                            switch (result.getInt("Result")) {
                                ...
                                case -3:
                                    ...
                                    break;
                                case 1:
                                    Toast.makeText(Activity, "Name Undefined", Toast.LENGTH_LONG).show();
                                    break;
                                case 2:
                                    Toast.makeText(Activity, "Too Many Group Undefined", Toast.LENGTH_LONG).show();
                                    break;
